...
// O período assumido quando a URL não diz qual é: a agenda inteira daqui
// pra frente, não só hoje. Já valia assim pra busca por texto (NI-41: quem
// digita o nome de uma casa quer a agenda dela, e responder só por hoje
// devolve zero resultados com cara de busca quebrada) — agora vale pra
// entrada na página também, com "todos os eventos" aceso por padrão.
export const periodoPadrao = () => 'proximos'
