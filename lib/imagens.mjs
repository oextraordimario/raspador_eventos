...
export const HOSTS_IMAGEM = [
  ...
  'ingresso-a.akamaihd.net',             // pôster de filme (Ingresso.com)
  // storage próprio (Vercel Blob, NI-37): pôster copiado + flyer do Instagram
  '6omceafxdzlvrs2m.public.blob.vercel-storage.com',
]
